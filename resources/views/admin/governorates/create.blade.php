...
<main class="app sidebar-mini rtl">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item"><a href="{{ route('governorates.index') }}"
                    title="المحافظة">المحافظة</a></li>
          
            <li class="breadcrumb-item active"><a href="{{ route('governorates.create') }}"
                    title="انشاء محافظة جديده">إانشاء محافظة جديده</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="col-lg-6">
                        <form action="{{route('governorates.store')}}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="exampleInputEmail1" name="name_en" value="{{old('name_en')}}"
                                    type="text" placeholder="اكتب المحافظة ">
                                @error('name_en')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
