...
<main class="app sidebar-mini rtl">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item"><a href="{{ route('terms.index') }}" title="الشروط والاحكام ">الشروط والاحكام
                </a></li>
  
            <li class="breadcrumb-item active"><a href="{{ route('terms.create') }}"
                ...
                <div class="tile-body">
                    <div class="col-lg-6">
                        <form action="{{route('terms.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">محتوى الشروط  باللغه الانجليزية</label>
                                <textarea class="form-control" id="editor_two" name="name_en"></textarea>
                                @error('name_en')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
