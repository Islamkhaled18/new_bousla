                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="organization_location_url" readonly
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if ($joinRequest->personal_image)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $joinRequest->personal_image) }}" target="_blank">
                                                    <img src="{{ asset('storage/' . $joinRequest->personal_image) }}"
                                                        alt="Personal Image" class="img-thumbnail" style="max-width: 150px; cursor: pointer;">
                                                </a>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if ($joinRequest->id_image_front)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $joinRequest->id_image_front) }}" target="_blank">
                                                    <img src="{{ asset('storage/' . $joinRequest->id_image_front) }}"
                                                        alt="ID Front" class="img-thumbnail" style="max-width: 150px; cursor: pointer;">
                                                </a>
                                                <p class="text-muted small">الصورة الحالية (اضغط للعرض بحجم كامل)</p>
                                            </div>
                                        @endif
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if ($joinRequest->id_image_back)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $joinRequest->id_image_back) }}" target="_blank">
                                                    <img src="{{ asset('storage/' . $joinRequest->id_image_back) }}"
                                                        alt="ID Back" class="img-thumbnail" style="max-width: 150px; cursor: pointer;">
                                                </a>
                                                <p class="text-muted small">الصورة الحالية (اضغط للعرض بحجم كامل)</p>
                                            </div>
                                        @endif
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if ($joinRequest->graduation_certificate)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $joinRequest->graduation_certificate) }}" target="_blank">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if ($joinRequest->professional_license)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $joinRequest->professional_license) }}" target="_blank">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        @if ($joinRequest->syndicate_card)
                                            <div class="mt-2">
                                                <a href="{{ asset('storage/' . $joinRequest->syndicate_card) }}" target="_blank">
                                                    <img src="{{ asset('storage/' . $joinRequest->syndicate_card) }}"
                                                        alt="Syndicate Card" class="img-thumbnail" style="max-width: 150px; cursor: pointer;">
                                                </a>
                            ...
                            <div class="form-group">
                                ...
                                @if ($joinRequest->images && $joinRequest->images->count() > 0)
                                    <div class="mt-3">
                                        ...
                                        <small class="form-text text-muted">اضغط على أي صورة لعرضها بحجم كامل في تاب جديد</small>
                                    </div>
                                @endif
                            </div>
