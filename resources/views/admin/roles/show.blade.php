    ...
    <main class="app sidebar-mini rtl">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="#" title=" @lang('role.show_role')"> @lang('role.show_role')</a></li>
            </ul>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" readonly class="form-control" value="{{ $role->name }}">
                                    </div>
                                </div>
                            </div>
                                            ...
                                            @foreach ($permissions as $permission)
                                                <div class="form-check"
                                                    ...
                                                    <input type="checkbox" name="permission[]" value="{{ $permission->id }}"
                                                        disabled  class="form-check-input permission-checkbox"
